# -*- coding: utf-8 -*-
"""Cost of Quality Tracker models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfQuality_cost_tracker(models.Model):
    _name = 'sf.quality_cost_tracker'
    _description = 'Cost of Quality Tracker'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.quality_cost_tracker') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.quality_cost_tracker'
