# -*- coding: utf-8 -*-
"""Supplier ABC Classification models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSupplier_pareto_abc(models.Model):
    _name = 'sf.supplier_pareto_abc'
    _description = 'Supplier ABC Classification'
    ...
    criticality = fields.Selection([
        ('critical', 'Critical - No Substitute'),
        ('important', 'Important'),
        ('standard', 'Standard'),
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_pareto_abc'
