# -*- coding: utf-8 -*-
"""Reference Program Manager models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfCustomer_reference_program(models.Model):
    _name = 'sf.customer_reference_program'
    _description = 'Reference Program Manager'
    ...
    reference_contact = fields.Char(string='Contact')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.customer_reference_program') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.customer_reference_program'
