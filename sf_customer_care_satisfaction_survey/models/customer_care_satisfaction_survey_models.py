...
class SfCustomer_care_satisfaction_survey(models.Model):
    _name = 'sf.customer_care_satisfaction_survey'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.customer_care_satisfaction_survey') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.customer_care_satisfaction_survey'
