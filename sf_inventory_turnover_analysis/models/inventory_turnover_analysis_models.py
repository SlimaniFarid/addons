# -*- coding: utf-8 -*-
"""Inventory Turnover Analysis models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfInventory_turnover_analysis(models.Model):
    _name = 'sf.inventory_turnover_analysis'
    _description = 'Inventory Turnover Analysis'
    ...
    avg_inventory_value = fields.Monetary(string='Avg Inventory Value')
    turnover_ratio = fields.Float(string='Turnover Ratio')
    benchmark = fields.Float(string='Benchmark')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.inventory_turnover_analysis') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.inventory_turnover_analysis'
