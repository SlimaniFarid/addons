# -*- coding: utf-8 -*-
"""Sales Territory Mapping models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfTerritory_mapping(models.Model):
    _name = 'sf.territory_mapping'
    _description = 'Sales Territory Mapping'
    ...
    zip_ranges = fields.Text(string='Zip/Postal Ranges')
