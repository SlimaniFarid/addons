# -*- coding: utf-8 -*-
"""Care QA Scorecard models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfCustomer_care_qa_scorecard(models.Model):
    _name = 'sf.customer_care_qa_scorecard'
    _description = 'Care QA Scorecard'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.customer_care_qa_scorecard') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.customer_care_qa_scorecard'
