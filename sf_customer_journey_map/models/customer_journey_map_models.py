...
class SfCustomer_journey_map(models.Model):
    _name = 'sf.customer_journey_map'
    ...
    touchpoints = fields.Html(string='Touchpoints')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.customer_journey_map') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.customer_journey_map'
