# -*- coding: utf-8 -*-
"""Demand Planning Review models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfDemand_planning_review(models.Model):
    _name = 'sf.demand_planning_review'
    _description = 'Demand Planning Review'
    ...
    bias_percent = fields.Float(string='Bias %')
    parameter_tuning = fields.Text(string='Parameter Tuning Notes')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.demand_planning_review') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.demand_planning_review'
