...
class SfProduction_order_sequencing2(models.Model):
    _name = 'sf.production_order_sequencing2'
    _description = 'Production Sequencing'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.production_order_sequencing2') or 'NEW'
