...
class SfSupplier_risk_mitigation_plan(models.Model):
    _name = 'sf.supplier_risk_mitigation_plan'
    ...
    risk_desc = fields.Text(string='Risk Description', required=True)
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_risk_mitigation_plan') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_risk_mitigation_plan'
