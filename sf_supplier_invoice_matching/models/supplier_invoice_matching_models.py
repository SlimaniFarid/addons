...
class SfSupplier_invoice_matching(models.Model):
    _name = 'sf.supplier_invoice_matching'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_invoice_matching') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_invoice_matching'
