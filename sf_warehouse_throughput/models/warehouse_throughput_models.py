# -*- coding: utf-8 -*-
"""Warehouse Throughput Monitor models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfWarehouse_throughput(models.Model):
    _name = 'sf.warehouse_throughput'
    _description = 'Warehouse Throughput Monitor'
    ...
    orders_picked = fields.Integer(string='Orders Picked')
    lines_picked = fields.Integer(string='Lines Picked')
    pick_errors = fields.Integer(string='Pick Errors')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.warehouse_throughput') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.warehouse_throughput'
