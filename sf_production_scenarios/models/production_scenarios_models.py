...
class SfProduction_scenarios(models.Model):
    _name = 'sf.production_scenarios'
    ...
    scenario_name = fields.Char(string='Scenario Name', required=True)
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.production_scenarios') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.production_scenarios'
