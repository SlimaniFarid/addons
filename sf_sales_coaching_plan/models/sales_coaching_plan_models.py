# -*- coding: utf-8 -*-
"""Sales Coaching Plan models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSales_coaching_plan(models.Model):
    _name = 'sf.sales_coaching_plan'
    _description = 'Sales Coaching Plan'
    ...
    skill_assessment = fields.Html(string='Skills Assessment')
    development_areas = fields.Text(string='Development Areas')
    coaching_milestones = fields.Html(string='Coaching Milestones')
...
class _Boost(models.Model):
    _inherit = 'sf.sales_coaching_plan'
