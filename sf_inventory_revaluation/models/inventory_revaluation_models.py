# -*- coding: utf-8 -*-
"""Inventory Revaluation Register models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfInventory_revaluation(models.Model):
    _name = 'sf.inventory_revaluation'
    _description = 'Inventory Revaluation Register'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.inventory_revaluation') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.inventory_revaluation'
