# -*- coding: utf-8 -*-
"""Supplier Capacity Review models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSupplier_capacity_review(models.Model):
    _name = 'sf.supplier_capacity_review'
    _description = 'Supplier Capacity Review'
    ...
    lead_time_impact = fields.Text(string='Lead Time Impact')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_capacity_review') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_capacity_review'
