# -*- coding: utf-8 -*-
"""Supplier Pricing History models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSupplier_pricing_history(models.Model):
    _name = 'sf.supplier_pricing_history'
    _description = 'Supplier Pricing History'
    ...
    change_percent = fields.Float(string='Change %')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_pricing_history') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_pricing_history'
