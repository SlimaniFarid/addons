# -*- coding: utf-8 -*-
"""Supplier Contract Database models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSupplier_contract_database(models.Model):
    _name = 'sf.supplier_contract_database'
    _description = 'Supplier Contract Database'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_contract_database') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_contract_database'
