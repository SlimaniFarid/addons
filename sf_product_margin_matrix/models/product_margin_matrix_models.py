# -*- coding: utf-8 -*-
"""Product Margin Matrix models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfProduct_margin_matrix(models.Model):
    _name = 'sf.product_margin_matrix'
    _description = 'Product Margin Matrix'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.product_margin_matrix') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.product_margin_matrix'
