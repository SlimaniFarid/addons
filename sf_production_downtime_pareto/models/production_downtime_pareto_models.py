# -*- coding: utf-8 -*-
"""Production Downtime Pareto models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfProduction_downtime_pareto(models.Model):
    _name = 'sf.production_downtime_pareto'
    _description = 'Production Downtime Pareto'
    ...
    downtime_reason = fields.Char(string='Downtime Reason', required=True)
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.production_downtime_pareto') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.production_downtime_pareto'
