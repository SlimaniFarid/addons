# -*- coding: utf-8 -*-
"""Purchase Requisition Templates models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfPurchase_requisition_template(models.Model):
    _name = 'sf.purchase_requisition_template'
    _description = 'Purchase Requisition Templates'
    ...
    items = fields.Text(string='Pre-approved Items')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.purchase_requisition_template') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.purchase_requisition_template'
