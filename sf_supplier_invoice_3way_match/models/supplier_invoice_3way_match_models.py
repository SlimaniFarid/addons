...
class SfSupplier_invoice_3way_match(models.Model):
    _name = 'sf.supplier_invoice_3way_match'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_invoice_3way_match') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_invoice_3way_match'
