# -*- coding: utf-8 -*-
"""Grievance Tracker models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfGrievance_tracker(models.Model):
    _name = 'sf.grievance_tracker'
    _description = 'Grievance Tracker'
