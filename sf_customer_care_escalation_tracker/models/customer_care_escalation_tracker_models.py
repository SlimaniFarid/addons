# -*- coding: utf-8 -*-
"""Escalation Tracker models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfCustomer_care_escalation_tracker(models.Model):
    _name = 'sf.customer_care_escalation_tracker'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.customer_care_escalation_tracker') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.customer_care_escalation_tracker'
