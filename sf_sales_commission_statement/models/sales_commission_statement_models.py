# -*- coding: utf-8 -*-
"""Commission Statement Generator models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSales_commission_statement(models.Model):
    _name = 'sf.sales_commission_statement'
    ...
    gross_commission = fields.Monetary(string='Gross Commission')
    deductions = fields.Monetary(string='Deductions')
    net_commission = fields.Monetary(string='Net Commission')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.sales_commission_statement') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.sales_commission_statement'
