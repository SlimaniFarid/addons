# -*- coding: utf-8 -*-
"""Contract Renewal Tracker models"""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class SfSupplier_contract_renewal_tracker(models.Model):
    _name = 'sf.supplier_contract_renewal_tracker'
    _description = 'Contract Renewal Tracker'
    ...
    performance_ok = fields.Boolean(string='Performance OK')
    renegotiation_note = fields.Text(string='Renegotiation')
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code(
                    'sf.supplier_contract_renewal_tracker') or 'NEW'
...
class _Boost(models.Model):
    _inherit = 'sf.supplier_contract_renewal_tracker'
